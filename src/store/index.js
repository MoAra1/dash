...
export default new Vuex.Store({
    state: {
        ...
        metaverseConfig: { // Prefilled with initial values
            name: 'Enverse',
            nickname: 'Core',
            server: 'http://164.92.104.108:9400', // This needs to at least be pre-filled in order to get all other config information.
            iceServer: '164.92.104.108:7337',
            serverVersion: 'version_tag":"1.1.1-20200107-abcdefg'
        },
        dialog: {
            notice: {
                title: '',
